"""
Mask R-CNN
Train on the toy Coin dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 coin.py train --dataset=/path/to/coin/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 coin.py train --dataset=/path/to/coin/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 coin.py train --dataset=/path/to/coin/dataset --weights=imagenet

    # Apply color splash to an image
    python3 coin.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 coin.py splash --weights=last --video=<URL or path to file>
"""
...
class CoinConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + coin
...
if __name__ == '__main__':
    ...
    # Train or evaluate
    if args.command == "train":
        train(model, int(args.num_epochs))
    elif args.command == "splash":
